...
def create_keyboard(language_code, keyboards_type):
    ...
    # دکمه‌های منوی چت هوش مصنوعی
        ...
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("💾 " + languages[language_code]['chat_saved'], callback_data='ai_save_chat')],
            [InlineKeyboardButton("✏️ " + languages[language_code]['rename_chat'], callback_data='ai_rename_chat'),
